      ...
      <div style={{ display: 'flex', flexDirection: 'column', height: '100dvh', background: 'transparent', color: '#e8e8ed', fontFamily: 'Inter,system-ui,sans-serif' }}>
        ...
        {(() => {
          ...
          return (
            ...
            {typeof document !== 'undefined' && !modal.open && createPortal(
            <div style={{ position: 'fixed', bottom: typeof window !== 'undefined' && (window as any).__VURIUM_IS_NATIVE ? 64 : 38, left: 0, right: 0, zIndex: 10003, padding: '0 8px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', pointerEvents: 'none' }}>
