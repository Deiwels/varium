  ...
  return (
    <div style={{ minHeight: '100vh', background: t.bg, fontFamily: 'Inter, -apple-system, sans-serif', color: t.text, position: 'relative' }}>
      ...
      <footer style={{ padding: '20px 24px', borderTop: `1px solid ${borderSoft}`, textAlign: 'center', position: 'relative', zIndex: 2 }}>
        <div style={{ fontSize: 10, color: isLightTheme ? 'rgba(0,0,0,.25)' : 'rgba(255,255,255,.18)', lineHeight: 1.6, marginBottom: 10, maxWidth: 400, margin: '0 auto 10px' }}>
          SMS notifications are optional. Message frequency varies. Message and data rates may apply. Reply STOP to unsubscribe or HELP for help. <a href="https://vurium.com/privacy#sms" target="_blank" rel="noopener" style={{ color: isLightTheme ? 'rgba(0,0,0,.3)' : 'rgba(255,255,255,.22)', textDecoration: 'none' }}>SMS Privacy Policy</a> &amp; <a href="https://vurium.com/terms#sms" target="_blank" rel="noopener" style={{ color: isLightTheme ? 'rgba(0,0,0,.3)' : 'rgba(255,255,255,.22)', textDecoration: 'none' }}>SMS Terms</a>.
        </div>
