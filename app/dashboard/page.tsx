    ...
    <Shell page="dashboard">
      ...
      {isMobile && (() => {
        ...
        const iconSvgs: Record<string,React.ReactNode> = {
          ...
          History: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/><polyline points="12 7 12 12 16 14"/></svg>,
