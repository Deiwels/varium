...
export default function SignInPage() {
  ...
  const btnStyle: React.CSSProperties = { width: '100%', height: 52, marginTop: 8, borderRadius: 14, border: '1px solid rgba(10,132,255,.65)', background: 'rgba(10,132,255,.14)', color: 'rgba(130,150,220,.6)', fontSize: 14, fontWeight: 900, letterSpacing: '.06em', textTransform: 'uppercase', cursor: 'pointer', fontFamily: 'inherit' }
  const errStyle: React.CSSProperties = { padding: '12px 16px', borderRadius: 12, border: '1px solid rgba(255,107,107,.30)', background: 'rgba(255,107,107,.08)', color: 'rgba(220,130,160,.5)', fontSize: 13, marginBottom: 12 }
    ...
    return (
      <div style={{ position: 'fixed', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#000', padding: 20, fontFamily: 'Inter, system-ui, sans-serif' }}>
        ...
        <div style={{ width: '100%', maxWidth: 400, borderRadius: 24, border: '1px solid rgba(255,255,255,.10)', background: 'linear-gradient(180deg,rgba(255,255,255,.06),rgba(255,255,255,.02))', boxShadow: '0 24px 80px rgba(0,0,0,.6)', backdropFilter: 'blur(20px)', padding: '36px 32px 32px' }}>
          <div style={{ fontFamily: '"Inter", sans-serif', letterSpacing: '.22em', textTransform: 'uppercase', fontSize: 18, textAlign: 'center', marginBottom: 6, color: '#e8e8ed' }}>Set your PIN</div>
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#000', padding: 20, fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      `}</style>
      <div style={{ width: '100%', maxWidth: 400, borderRadius: 24, border: '1px solid rgba(255,255,255,.10)', background: 'linear-gradient(180deg,rgba(255,255,255,.06),rgba(255,255,255,.02))', boxShadow: '0 24px 80px rgba(0,0,0,.6)', backdropFilter: 'blur(20px)', padding: '36px 32px 32px' }}>
        <div style={{ fontFamily: '"Inter", sans-serif', letterSpacing: '.22em', textTransform: 'uppercase', fontSize: 20, textAlign: 'center', marginBottom: 6, color: '#e8e8ed' }}>Element</div>
