                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginTop: 4 }}>
                            ...
                            <label htmlFor="wl-sms-consent" style={{ fontSize: 12, color: textMuted, lineHeight: 1.5, cursor: 'pointer' }}>
                              By providing your phone number, you agree to receive SMS appointment confirmations, reminders, and changes from <strong>{shopName || 'this business'}</strong>. Message frequency may vary, up to 5 msgs per booking. Msg &amp; data rates may apply. Reply STOP to opt out. Reply HELP for help. We will not share your mobile information with third parties for promotional purposes. <a href="https://vurium.com/privacy#sms" target="_blank" rel="noopener" style={{ color: 'rgba(130,150,220,.6)', textDecoration: 'none' }}>SMS Privacy Policy</a> &amp; <a href="https://vurium.com/terms#sms" target="_blank" rel="noopener" style={{ color: 'rgba(130,150,220,.6)', textDecoration: 'none' }}>SMS Terms of Service</a>.
                            </label>
                          </div>
                        </div>
