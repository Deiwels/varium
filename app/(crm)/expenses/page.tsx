...
const CATEGORY_COLORS: Record<string, string> = {
  Rent: '#ff6b6b', Supplies: '#8b9aff', Equipment: '#bf5af2', Utilities: '#ffcf3f',
  Marketing: '#ff9f0a', Insurance: '#30d158', Maintenance: '#64d2ff', Software: '#5e5ce6', Other: 'rgba(255,255,255,.35)',
}
const FALLBACK_COLORS = ['#ff6b6b','#8b9aff','#bf5af2','#ffcf3f','#ff9f0a','#30d158','#64d2ff','#5e5ce6','#ff5aa5','#35d6c7']
        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 70, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#000', gap: 16 }}>
          <div style={{ position: 'relative', width: 80, height: 80, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <svg viewBox="0 0 80 80" fill="none" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', animation: 'expSpin 1.2s linear infinite' }}>
              ...
              <path d="M40 2a38 38 0 0 1 38 38" stroke="#c8d0ff" strokeWidth="2.5" strokeLinecap="round" />
            </svg>
          </div>
          ...
          <div style={{ width: 'min(420px,100%)', borderRadius: 24, border: '1px solid rgba(255,255,255,.10)', background: 'rgba(10,10,20,.90)', backdropFilter: 'saturate(180%) blur(40px)', color: '#e9e9e9', fontFamily: 'Inter,sans-serif', boxShadow: '0 30px 80px rgba(0,0,0,.55)', overflow: 'hidden', animation: 'modalIn .3s cubic-bezier(.4,0,.2,1)' }}>
            ...
            <div style={{ padding: '18px', display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div style={{ display: 'flex', gap: 8, marginTop: 4 }}>
                ...
                <button onClick={handleSave} disabled={saving} style={{ flex: 1, height: 44, borderRadius: 12, border: '1px solid rgba(139,154,255,.50)', background: 'rgba(139,154,255,.12)', color: '#c8d0ff', cursor: 'pointer', fontWeight: 900, fontSize: 13, fontFamily: 'inherit', opacity: saving ? .5 : 1, transition: 'all .2s' }}>
