      ...
      <div style={{ display: 'flex', flexDirection: 'column', height: '100dvh', background: 'transparent', color: '#e8e8ed', fontFamily: 'Inter,system-ui,sans-serif' }}>
        ...
        {(() => {
          ...
          return (
            ...
            <div className="date-dot-wrap" style={{ position: 'fixed', bottom: 85, left: 0, right: 0, zIndex: 10001, display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 5, padding: '3px 0', pointerEvents: 'auto' }}>
            ...
            {typeof document !== 'undefined' && createPortal(
            <div style={{ position: 'fixed', bottom: 82, left: 0, right: 0, zIndex: 10002, padding: '0 12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', pointerEvents: 'none' }}>
