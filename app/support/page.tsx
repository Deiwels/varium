  ...
  return (
    <>
      ...
      <main style={{ minHeight: '100vh', maxWidth: 800, margin: '0 auto', padding: 'clamp(100px, 12vh, 140px) 24px 80px', position: 'relative', zIndex: 2 }}>
        ...
        <h2 style={heading}>2. Response Times &amp; Support Priorities</h2>
        <p style={text}>We review requests by urgency and aim to respond as quickly as possible during business hours:</p>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 14, color: 'rgba(255,255,255,.45)' }}>
            <thead>
              <tr style={{ borderBottom: '1px solid rgba(255,255,255,.1)' }}>
                ...
                <th style={{ textAlign: 'left', padding: '12px 14px', color: 'rgba(255,255,255,.55)', fontWeight: 600 }}>Typical First Reply</th>
                <th style={{ textAlign: 'left', padding: '12px 14px', color: 'rgba(255,255,255,.55)', fontWeight: 600 }}>Next Step</th>
                <th style={{ textAlign: 'left', padding: '12px 14px', color: 'rgba(255,255,255,.55)', fontWeight: 600 }}>Handling</th>
              </tr>
            </thead>
            <tbody>
              <tr style={{ borderBottom: '1px solid rgba(255,255,255,.05)' }}>
                ...
                <td style={{ padding: '12px 14px' }}>As soon as possible</td>
                <td style={{ padding: '12px 14px' }}>Active incident handling</td>
                <td style={{ padding: '12px 14px' }}>Escalated internally right away</td>
              </tr>
              <tr style={{ borderBottom: '1px solid rgba(255,255,255,.05)' }}>
                ...
                <td style={{ padding: '12px 14px' }}>Usually same business day</td>
                <td style={{ padding: '12px 14px' }}>Triaged with a follow-up update</td>
                <td style={{ padding: '12px 14px' }}>Routed to product or engineering</td>
              </tr>
              <tr style={{ borderBottom: '1px solid rgba(255,255,255,.05)' }}>
                ...
                <td style={{ padding: '12px 14px' }}>Usually within 1 business day</td>
                <td style={{ padding: '12px 14px' }}>Scheduled or answered in follow-up</td>
                <td style={{ padding: '12px 14px' }}>Added to the backlog when needed</td>
              </tr>
              <tr style={{ borderBottom: '1px solid rgba(255,255,255,.05)' }}>
                ...
                <td style={{ padding: '12px 14px' }}>Usually within 2 business days</td>
                <td style={{ padding: '12px 14px' }}>Answered or routed to the right team</td>
                <td style={{ padding: '12px 14px' }}>May be covered in docs or follow-up email</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div style={card}>
          <ul style={{ ...list, marginBottom: 0 }}>
            ...
            <li><strong style={{ color: 'rgba(255,255,255,.55)' }}>Email notification:</strong> When practical, affected users are notified by email with the current status and any actions they may need to take.</li>
            <li><strong style={{ color: 'rgba(255,255,255,.55)' }}>Data incident handling:</strong> If an incident affects personal data, we follow the notification process required by applicable law and our published policies.</li>
            <li><strong style={{ color: 'rgba(255,255,255,.55)' }}>Follow-up:</strong> After major incidents, we share the cause and the next safeguards we are putting in place.</li>
          </ul>
        </div>
        ...
        <div style={card}>
          <ul style={{ ...list, marginBottom: 0 }}>
            ...
            <li><strong style={{ color: 'rgba(255,255,255,.55)' }}>Deletion:</strong> Request deletion of your personal data. We review deletion requests in line with our retention obligations and applicable law.</li>
        ...
        <div style={{ ...card, background: 'rgba(130,150,220,.03)', border: '1px solid rgba(130,150,220,.08)' }}>
          <p style={{ ...text, marginBottom: 0, fontSize: 13 }}>
            <strong style={{ color: 'rgba(255,255,255,.45)' }}>Privacy notice:</strong> When you contact support, we process your name, email, and inquiry details to resolve your issue. This data is handled according to our <a href="/privacy" style={{ color: 'rgba(130,150,220,.7)', textDecoration: 'none' }}>Privacy Policy</a>, stored securely, and retained only as long as necessary to provide support.
          </p>
        </div>
        ...
        <div style={card}>
          <ul style={{ ...list, marginBottom: 0 }}>
            ...
            <li>We review reports as quickly as possible and follow up with next steps once we validate the issue.</li>
          </ul>
        </div>
        <p style={text}>
        ...
        <div style={card}>
          ...
          <p style={{ ...text, marginBottom: 0, marginTop: 8 }}>
            Email <a href="mailto:support@vurium.com" style={{ color: 'rgba(130,150,220,.7)', textDecoration: 'none' }}>support@vurium.com</a> with the subject &quot;Account Deletion Request.&quot; We will verify your identity and process the deletion request in line with our retention obligations and applicable law. You may also request a data export before deletion.
          </p>
        </div>
        ...
        <div style={card}>
          ...
          <p style={{ ...text, marginBottom: 0, marginTop: 8 }}>
            We take privacy and security seriously. Payment details are handled through trusted providers, and our privacy documentation explains how personal information is used and protected. See our <a href="/privacy" style={{ color: 'rgba(130,150,220,.7)', textDecoration: 'none' }}>Privacy Policy</a> for full details.
          </p>
        </div>
