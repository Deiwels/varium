    ...
    <Shell page="dashboard">
      ...
      {isMobile && (() => {
        ...
        const iconSvgs: Record<string,React.ReactNode> = {
          ...
          History: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M1 4v6h6"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/><circle cx="12" cy="14" r="1" fill="currentColor" stroke="none"/><polyline points="12 8 12 14 15.5 16"/></svg>,
