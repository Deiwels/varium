...
Цей документ — **операційний reference guide** про те, як команда `Owner + 11 AI` додає, перейменовує, лінкує і структурує файли в `docs/`. Ціль — щоб граф Obsidian залишався читабельним, без сиріт, без broken links, з чіткими hub-кластерами.

**Перед тим як створити або відредагувати markdown-файл — прочитай цей документ повністю.**
